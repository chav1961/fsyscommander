...
import chav1961.purelib.basic.util.FileKeeper;
...
public class EditorSettings implements FormManager<Object,EditorSettings>, Cloneable, Resettable {
	...
	@Override
	public RefreshMode onField(final EditorSettings inst, final Object id, final String fieldName, final Object oldValue, final boolean beforeCommit) throws FlowException, LocalizationException {
